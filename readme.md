...
* Auxiliar os Profissionais de Saúde na totalização do resumo mensal de SAAJ com exatidão e prontidão; 
...
* Expandir o acesso à ficha de resumo mensal de SAAJ.
...
* Ter colhido os dados de todos os indicadores da ficha nas respectivas fontes primárias (livro(s) de registo de consultas de SAAJ) da sua Unidade Sanitária;
